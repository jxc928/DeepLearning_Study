...
#
## shuffle=True/False: if shuffle the filename_queue
filename_queue = tf.train.string_input_producer(
    ['data-01-test-score.csv'], shuffle=False, name='filename_queue')

reader = tf.TextLineReader(skip_header_lines=1)  # skip header line
key, value = reader.read(filename_queue)
print(key, value)  # Tensor("ReaderReadV2:0", shape=(), dtype=string) Tensor("ReaderReadV2:1", shape=(), dtype=string)
...
print(sess.run(key))  # b'data-01-test-score.csv:3'
